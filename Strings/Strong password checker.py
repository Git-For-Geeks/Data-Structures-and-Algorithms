# Dividing the problem into three sub-problems
    ...
    # Length of password is between 6 and 20 characters, including both.
    # And string length is greater than 20 characters.
    # Strong password should have at least one lowercase letter, at least one uppercase letter, and at least one digit. 

# When the string length is greater than 20 characters, we can have three cases:
...
# For any repeating sequences with length % 3 == 1, we can reduce one replacement by deleting two character. 
